...
- AV-safe I/O: aggregate commands (one `rg`/`jq` over a file list, not per-file loops), no temp/intermediate file writes; conclusions go in your final message only. (Sophos CryptoGuard flags file-I/O bursts.)
