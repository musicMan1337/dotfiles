...
**For:** producing copy after a booking is confirmed. Show descriptions for venue event pages, Facebook/Instagram event bodies, short social captions, longer "about the band" bios for press kits or websites.
...
- **Length discipline.** Every sentence does work. If a line could be deleted without losing meaning or character, delete it. Short copy is usually the harder craft — lean in.
- **First-person collective is the default voice.** "We're 8 Bit Mammoth," "we play," "we love" — this is the register that's landed. Use third-person only when the format explicitly calls for it (long-form bios, press kits) or the user asks.
- **Nostalgia is fair game.** The shared-memory pull of game music is a real part of why people show up — don't sanitize it out. "That sweet nostalgia beat," "the songs you grew up on," "soundtracks we grew up loving" — all welcome when they fit.
