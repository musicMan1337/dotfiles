...
| Vegetable Cake | 47 | 8 Flour, 8 Tomato, 7 Lettuce, 8 Eggs, 4 Honey | **2 eggs** per cycle |
...
- From scratch, a 4-passive stack is commonly 15–25 cycles. Surgery Table can implant a passive for Gold to seed parents, but the best breed-only passives (Legend-tier) cannot be implanted.
...
**Endgame pal recipe:** (1) breed the ideal 4-passive set, (2) breed/select high IVs with IV-locked parents, (3) condense to 4★, (4) pour souls into the key stat (usually ATK or Work Speed). Do breeding (passives+IVs) before sinking condensation/souls, so you don't invest in a pal you later cull.
